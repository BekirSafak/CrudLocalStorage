let userList = [], getUserList, nameListDOM;
...
function Delete(item) {
    // ? Fonksiyon içerisine gelen item tıklanan index.
    let deleteUsers = JSON.parse(localStorage.getItem('userList'));
    deleteUsers.splice(item, 1); // ? Tıklanan itemdan sonra 1 tane sil.
...
// ? Sayfa yüklendikten sonra Read() çalışır.
